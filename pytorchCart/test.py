...
parser.add_argument('--image_dir', required=True, default='test', help='test image path')
...
image_src = utils.data_load(os.path.join('data', args.src_data), 'test', src_transform, 1, shuffle=True, drop_last=True)
